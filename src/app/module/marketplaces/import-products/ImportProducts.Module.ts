...
import { GoogleMerchantImportStrategy } from 'src/core/interactors/marketplace/import-products/strategies/GoogleMerchantImportStrategy';
...
import { GetGoogleMerchantProductsRepository } from 'src/core/drivers/repositories/marketplace-api/google-merchant/products/get/GetGoogleMerchantProductsRepository';
...
@Module({
  providers: [
    ...
    {
      provide: 'IGetGoogleMerchantProductsRepository',
      useClass: GetGoogleMerchantProductsRepository
    },

    GetMegatoneProductsAdapter,
    GetOnCityProductsAdapter,
    GetFravegaProductsAdapter,
    GetGoogleMerchantProductsAdapter,

    MegatoneImportStrategy,
    OnCityImportStrategy,
    FravegaImportStrategy,
    GoogleMerchantImportStrategy,
