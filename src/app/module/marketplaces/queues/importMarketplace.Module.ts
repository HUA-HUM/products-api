...
import { ImportMarketplaceCronService } from 'src/app/services/marketplace/imports/ImportMarketplaceCronService';
...
@Module({
  ...
  providers: [ImportMarketplaceService, ImportMarketplaceWorker, ImportMarketplaceCronService]
})
